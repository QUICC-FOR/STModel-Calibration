...
#    annualProba = 1 - exp(log(1-proba)/itime)
	...
	lik[st0 == "B" & st1 == "M"] = (alphat*betat*(ET+EM)*(1-eps))[st0 == "B" & st1 == "M"] 
	lik[st0 == "B" & st1 == "R"] = eps[st0 == "B" & st1 == "R"] 	
	lik[st0 == "B" & st1 == "B"] = (1 - eps - alphat*betat*(ET+EM)*(1-eps))[st0 == "B" & st1 == "B"]

	lik[st0 == "T" & st1 == "T"] = (1 - eps - alphab*betab*(EB+EM)*(1-eps))[st0 == "T" & st1 == "T"] 	
	lik[st0 == "T" & st1 == "M"] = (alphab*betab*(EB+EM)*(1-eps))[st0 == "T" & st1 == "M"] 			
