...
load(paste("../estimated_params/GenSA_initForFit_", strsplit(fit, "_")[[1]][1], "_0.1.RData", sep = ""))
...
estim.pars = GenSA(par = params, fn = model, lower = par_lo, upper= par_hi, control = list(verbose =TRUE, maxit = 6000, smooth=FALSE), dat = datSel)
