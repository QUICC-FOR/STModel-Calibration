...
e7 = 0
    ...
    logit_alphab 	= params["ab0"] + params["ab1"]*ENV1 + params["ab2"]*ENV2 
    logit_alphat 	= params["at0"] + params["at1"]*ENV1 + params["at2"]*ENV2 
    logit_betab 	= params["bb0"] + params["bb1"]*ENV1 + params["bb2"]*ENV2 
    logit_betat 	= params["bt0"] + params["bt1"]*ENV1 + params["bt2"]*ENV2 
    logit_theta	= params["th0"] + params["th1"]*ENV1 + params["th2"]*ENV2 
    logit_thetat	= params["tt0"] + params["tt1"]*ENV1 + params["tt2"]*ENV2 
    logit_eps 	= params["e0"]  + params["e1"]*ENV1 + params["e2"]*ENV2  
