...
ns = 20, nt = 100, max_iter = 50000, min_change = 0, min_drops = 100, hessian = FALSE, delta = 100, slimit = 2, note = "", support = FALSE,
progress = TRUE, display=FALSE, ...) {
