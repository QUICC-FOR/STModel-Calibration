...
name = paste("rf_all_alphabeta_", ordre, "_", step,"y_rep",rep, sep="")
#------------------------------
source(paste("3-transition_model_alphabeta_",ordre,".R", sep =""))
#------------------------------
...
estim.pars = GenSA(par = params, fn = model, lower = par_lo, upper= par_hi, control = list(verbose =TRUE, smooth=FALSE, temperature = 7000, nb.stop.improvement=1000, max.time= 80000, trace.fn = paste("../estimated_params/traceMat_", name,".trMat", sep="")), dat = datSel, step=step)
